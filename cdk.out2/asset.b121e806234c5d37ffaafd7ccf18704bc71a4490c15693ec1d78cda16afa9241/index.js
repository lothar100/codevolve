...
// src/registry/listProblems.ts
var listProblems_exports = {};
__export(listProblems_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(listProblems_exports);
...
// src/registry/listProblems.ts
var ListProblemsParamsSchema = external_exports.object({
  ...
  status: external_exports.string().default("active")
});
...
function mapProblemFromDynamo(item) {
  return {
    ...
    domain: item.domain,
    tags: item.tags ?? [],
    ...item.constraints !== void 0 ? { constraints: item.constraints } : {},
    examples: item.examples ?? [],
    canonical_skill_id: item.canonical_skill_id ?? null,
