...
var listSkills_exports = {};
__export(listSkills_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(listSkills_exports);
...
// src/registry/listSkills.ts
var ListSkillsParamsSchema = external_exports.object({
  ...
  domain: external_exports.union([external_exports.string(), external_exports.array(external_exports.string())]).optional(),
  tag: external_exports.union([external_exports.string(), external_exports.array(external_exports.string())]).optional(),
  status: external_exports.union([external_exports.string(), external_exports.array(external_exports.string())]).optional(),
  problem_id: external_exports.string().uuid().optional(),
  is_canonical: external_exports.enum(["true", "false"]).transform((v) => v === "true").optional(),
  include_archived: external_exports.enum(["true", "false"]).transform((v) => v === "true").default("false"),
  sort_by: external_exports.string().optional(),
  sort_order: external_exports.enum(["asc", "desc"]).default("desc"),
...
async function handler(event) {
  try {
    ...
    const domains = params.domain ? Array.isArray(params.domain) ? params.domain : [params.domain] : [];
    ...
    const nextToken = lastEvaluatedKey ? Buffer.from(JSON.stringify(lastEvaluatedKey)).toString("base64") : null;
    return success(200, {
      skills,
      pagination: {
        limit: params.limit,
