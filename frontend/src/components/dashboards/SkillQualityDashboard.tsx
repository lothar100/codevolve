  ...
  return (
    <div className="dashboard skill-quality-dashboard">
      ...
      <section>
        ...
        {data.test_pass_rates.length === 0 ? (
          <p className="section-empty">No skills validated yet.</p>
        ) : (
      ...
      <section>
        ...
        {data.confidence_over_time.length === 0 ? (
          <p className="section-empty">No validation history recorded yet.</p>
        ) : (
      ...
      <section>
        ...
        {data.competing_implementations.length === 0 ? (
          <p className="section-empty">No competing implementations detected yet.</p>
        ) : (
          <table className="dashboard-table">
            <thead>
              <tr>
      ...
      <section>
        ...
        {data.confidence_degradation.length === 0 ? (
          <p className="section-empty">No confidence degradation detected.</p>
        ) : (
          <table className="dashboard-table">
            <thead>
              <tr>
