    ...
    <div className="dashboard execution-caching-dashboard">
      ...
      <section>
        ...
        {data.top_skills.length === 0 ? (
          <p className="section-empty">No executions recorded yet.</p>
        ) : (
      ...
      <section>
        ...
        {data.cache_rate_over_time.length === 0 ? (
          <p className="section-empty">No executions recorded yet.</p>
        ) : (
      ...
      <section>
        ...
        {data.execution_latency_over_time.length === 0 ? (
          <p className="section-empty">No executions recorded yet.</p>
        ) : (
          <ResponsiveContainer width="100%" height={240}>
      ...
      <section>
        ...
        {data.cache_candidates.length === 0 ? (
          <p className="section-empty">No cache candidates identified yet.</p>
        ) : (
          <table className="dashboard-table">
            <thead>
              <tr>
