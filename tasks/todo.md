...
| IMPL-14 | Ada | [ ] | Implement mountain visualization frontend (React + Three.js). Full spec: `docs/platform-design.md` §DESIGN-05. | DESIGN-05 |
...
| IMPL-17 | Ada | [ ] | Implement edge caching CDK: CloudFront distribution, S3 bucket for mountain frontend, OAC, API Gateway cache, cache invalidation in write Lambdas. Full spec: `docs/architecture.md §Edge Caching` and ADR-010. | ARCH-09 |
